...
if int(expInfo['session']) == 1:
    cueversions = [3,0,3,3,2,3,1,4,2,5,0,5,4,2,5,1,0,4,2,5,4,1,0,1,5.0,1,3,2,4,
                  2,5,4,2,5,3,0,3,1,2,5,4,5,1,5,4,4,2,3,0,4,1,2,0,3,5,3,5,2,1,4,0,3,1,0,0,1]
elif int(expInfo['session']) == 2:
    cueversions = [1,2,5,4,1,5,4,0,0,1,4,4,0,2,3,2,3,3,5,1,0,5,3,2,1,3,5,4,0,2,
                   0,2,4,1,3,5,3,4,0,1,2,1,4,0,3,4,2,1,5,1,3,5,0,3,5,4,2,1,3,0,5,2,1,4,4,3,5,0,2,1,5,1,4,3,0,2,1,4,3,5,2,1,0,1,2,3,4,5,0,1]
elif int(expInfo['session']) == 3:
    cueversions = [4,4,4,4,2,5,0,1,5,5,1,4,3,0,2,4,1,3,3,1,3,2,0,0,5,2,3,4,0,1,3,4,2,5,2,1,3,3,5,4,1,4,2,3,0,5,1,0,2,4,0,5,0,1,3]
elif int(expInfo['session']) == 4:
    cueversions = [1,2,2,2,3,3,4,5,1,5,0,0,2,0,0,4,1,3,3,5,4,5,4,1,0,2,4,4,1,3,5,4,2,3,1,0,0,0,0,1,3,5,4,3,0,2,1,5,1,2,0,4,3,4,3,0,2,5,1]            
